...
public interface ICond {
     ...
     */
    String getWhereClouse(FieldInfo fi) throws FieldNotFoundException;
     ...
     * @return 下一个要拼接的参数下标
     */
    int setPrepareStatement(FieldInfo fi, PreparedStatement pstmt, int paramIndex) throws AssignToStatementException, FieldNotFoundException;
}
